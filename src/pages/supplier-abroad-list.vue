<!--这是供应商列表页面-->
<template>
    <div class="supplier-abroad-list-page" @click="globalFun">
       <div class="list-header">
           <!-- 供应商导航引入 -->
          <supplierHeader :indexPlan="indexPlan" :without="without" :isHide="isHide" @select-type="navIndex" @global="globalFunT" @refreshList="abroadInit"></supplierHeader>
          <div class="list-condition-area">
            <p>您当前所在位置：<a :href="'#/supplier?orgId=' + orgId">首页 > </a><span>境外游</span></p>
               <ul>
                   <li v-if="false">
                   ...
                   <li>
                       ...
                       <div class="supplier-content supplier-content-esp">
                        ...
                        <!-- <p class="destination-city" v-if="destinationIndex!=-1">
                            <a href="javascript:;" v-for="(city,index) in destinationList[destinationIndex].citys" @click.stop.prevent="destinationSearch(city,index)" :class="destinationSelectIndex==index?'active':''">{{city.destname}}</a>
                        </p> -->
                   </li>
                   <li>
