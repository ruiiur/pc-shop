...
<template>
    <div class="pay">
        <!-- 引入头部导航 -->
        <supplierHeader  :without="without"  :isHide="isHide"  @refreshList="payInit"></supplierHeader>
            ...
            if(this.payState==1){
                ...
                postPayment(params).then(response => {
                    ...
                    if (response.meta.success == true) {
                        ...
                        this.$router.push('/pay-result/'+this.orderId);
                        // this.$Message.success('支付申请提交成功');
                        //  setTimeout(()=>{
